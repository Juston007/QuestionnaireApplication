...
public class SystemBarTintManager {
	...
	public static void setStatusColor(Activity aty, Window window) {
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) { // 系统版本大于19
			setTranslucentStatus(true, window);
		}
		SystemBarTintManager tintManager = new SystemBarTintManager(aty);
		tintManager.setStatusBarTintEnabled(true);
		tintManager.setStatusBarTintResource(R.color.statusColor);
	}

	private static void setTranslucentStatus(boolean on, Window window) {
		Window win = window;
